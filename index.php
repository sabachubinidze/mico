...
<head>
  ...
  <?php require 'HospitalTreatment.php'?>
  <?php require ('doctors.php') ?>
  <?php require 'testimonialsection.php' ?>
</head>
...
<body>
  ...
  <div class="hero_area">
    ...
    <!-- slider section -->
    <?php
    require('slider.php'); generateSliderSection(); ?> 
    <!-- end slider section -->
  </div>
